...
import charts.graphs as graphs


def Reportgen(from_time, to_time, df):
    # Sample data (replace with your actual data)
    company_name = "PROLITE AUTOMATION"
    logo_path = "C:\\prolite\\Skew_app\\data_files\\logo.png"  # Adjust to the local path of your logo file
    from_date = from_time
    to_date = to_time
    ...
    # Generate the graph image as base64
    graph_image_base64 = graphs.report_graph(df)
    ...
    <body>
        ...
        <div class="graph-container">
            <img src="{{ graph_image_base64 }}" alt="Graph">
        </div>
        <table>
            <thead>
                <tr>
    ...
    # Save HTML to file
    html_file_path = "C:\\prolite\\Skew_app\\data_files\\report.html"
    pdf_file_path = "C:\\prolite\\Skew_app\\data_files\\report.pdf"
    ...
    try:
        ...
        if pisa_status.err:
            print(f"An error occurred while generating the PDF: {pisa_status.err}")
        else:
...
# Reportgen("2023-01-01", "2023-12-31", df)


def report_html_to_print(from_time, to_time, df):
    # Sample data (replace with your actual data)
    company_name = "PROLITE AUTOMATION"
    logo_path = "C:\\prolite\\Skew_app\\data_files\\logo.png"  # Adjust to the local path of your logo file
    from_date = from_time
    ...
    graph_html = graphs.report_graph(df)
    ...
    try:
        ...
        # Convert HTML to PDF using pdfkit with wkhtmltopdf configuration
        pdfkit_config = pdfkit.configuration(wkhtmltopdf='C:\\Program Files\\wkhtmltopdf\\bin\\wkhtmltopdf.exe')
        pdfkit.from_file(html_file_path, pdf_file_path, configuration=pdfkit_config, options={
            'enable-local-file-access': None  # This is necessary for wkhtmltopdf to access local files
        })
        print(f"PDF report generated and saved as {pdf_file_path}")
    except Exception as e:
        print(f"An error occurred: {e}")
